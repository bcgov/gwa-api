...
def create_consumer_plugin(namespace: str, consumer_id: str) -> object:
    ...
    if pluginData == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerPlugin', action='add', namespace=namespace, message='failed to create plugin.')
...
def update_consumer_plugin(namespace: str, consumer_id: str, plugin_id: str) -> object:
    ...
    if pluginData == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerPlugin', action='update', namespace=namespace, message='failed to update plugin.')
...
def delete_consumer_plugin(namespace: str, consumer_id: str, plugin_id: str) -> object:
    ...
    try:
        ...
        handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerPlugin', action='delete', namespace=namespace, message='failed to delete plugin.')
...
def create_consumer(namespace: str):
    ...
    if consumerData == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumer', action='create', namespace=namespace, message='failed to create consumer.')
...
def update_consumer(namespace: str, username: str):
    ...
    if consumerData == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumer', action='update', namespace=namespace, message='failed to update consumer.')
...
def delete_consumer(namespace: str, username: str) -> object:
    ...
    try:
        ...
        handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumer', action='delete', namespace=namespace, message='failed to delete consumer.')
...
def add_consumer_keyauth(namespace: str, consumer_id: str) -> object:
    ...
    if keyauth_data == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerKeyAuth', action='add', namespace=namespace, message='failed to add keyauth to consumer.')
...
def generate_consumer_keyauth_key(namespace: str, consumer_id: str, keyauth_id: str):
    ...
    if key_data == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerKeyAuth', action='update', namespace=namespace, message='failed to generate key for consumer keyauth.')
...
def assign_consumer_acl (namespace: str, consumer_id: str) -> object:
    ...
    if acl_data == None:
        ...
        try:
            ...
            handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerACL', action='add', namespace=namespace, message='failed to add consumer ACL.')
...
def remove_consumer_acl(namespace: str, consumer_id: str, acl_id: str) -> object:
    ...
    try:
        ...
        handle_exceptions(exception=ex, event_id=event_id, type='GatewayConsumerACL', action='delete', namespace=namespace, message='failed to delete consumer ACL.')
...
def handle_exceptions(**kwargs):
    ...
    if not kwargs['exception'] == None:
        ...
        traceback.print_exc()
        record_custom_event(kwargs['event_id'], kwargs['type'], kwargs['action'], 'failed', kwargs['namespace'], kwargs['message'])
